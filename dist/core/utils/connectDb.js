 ...
 */
var initializeTestEnvironment = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, mongoose_1.default.connect(CONNECTION_STRING)];
            case 1:
                _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error("❌ Error al inicializar el entorno:", error_1);
                process.exit(1);
                return [3 /*break*/, 4];
...
var disconnectMongo = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
